...
<div id="ctxtnav" class="nav">
 <ul>
  <li class="first"><a href="/changeset/3/FCKeditor/trunk/editor/filemanager/browser/default/connectors/perl/basexml.pl">
   Last Change</a></li>
  <li class="last"><a href="/log/FCKeditor/trunk/editor/filemanager/browser/default/connectors/perl/basexml.pl?rev=8">
   Revision Log</a></li>
 </ul>
</div>
...
<td><B><span class="code-lang">sub</span></b>&nbsp;CreateXmlHeader</td>
</tr><tr><th id="L9"><a href="#L9">9</a></th>
<td>{</td>
</tr><tr><th id="L10"><a href="#L10">10</a></th>
<td>&nbsp; &nbsp; &nbsp; &nbsp; <B><span class="code-lang">local</span></b>($command,$resourceType,$currentFolder) = @_;</td>
</tr><tr><th id="L11"><a href="#L11">11</a></th>
<td></td>
</tr><tr><th id="L12"><a href="#L12">12</a></th>
<td>&nbsp; &nbsp; &nbsp; &nbsp; <I><span class="code-comment"># Create the XML document header.</span></i></td>
</tr><tr><th id="L13"><a href="#L13">13</a></th>
<td><I><span class="code-comment"></span></i>&nbsp;&nbsp; &nbsp; &nbsp; &nbsp;<B><span class="code-lang">print</span></b> <B><span class="code-string">'&lt;?xml version=&quot;1.0&quot; encoding=&quot;utf-8&quot; ?&gt;'</span></b>;</td>
</tr><tr><th id="L14"><a href="#L14">14</a></th>
<td></td>
</tr><tr><th id="L15"><a href="#L15">15</a></th>
<td>&nbsp; &nbsp; &nbsp; &nbsp; <I><span class="code-comment"># Create the main &quot;Connector&quot; node.</span></i></td>
</tr><tr><th id="L16"><a href="#L16">16</a></th>
<td><I><span class="code-comment"></span></i>&nbsp;&nbsp; &nbsp; &nbsp; &nbsp;<B><span class="code-lang">print</span></b> <B><span class="code-string">'&lt;Connector command=&quot;'</span></b> . $command . <B><span class="code-string">'&quot; resourceType=&quot;'</span></b> . $resourceType . <B><span class="code-string">'&quot;&gt;'</span></b>;</td>
</tr><tr><th id="L17"><a href="#L17">17</a></th>
<td></td>
</tr><tr><th id="L18"><a href="#L18">18</a></th>
<td>&nbsp; &nbsp; &nbsp; &nbsp; <I><span class="code-comment"># Add the current folder node.</span></i></td>
</tr><tr><th id="L19"><a href="#L19">19</a></th>
<td><I><span class="code-comment"></span></i>&nbsp;&nbsp; &nbsp; &nbsp; &nbsp;<B><span class="code-lang">print</span></b> <B><span class="code-string">'&lt;CurrentFolder path=&quot;'</span></b> . ConvertToXmlAttribute($currentFolder) . <B><span class="code-string">'&quot; url=&quot;'</span></b> . ConvertToXmlAttribute(GetUrlFromPath($resourceType,$currentFolder)) . <B><span class="code-string">'&quot; /&gt;'</span></b>;</td>
</tr><tr><th id="L20"><a href="#L20">20</a></th>
<td>}</td>
</tr><tr><th id="L21"><a href="#L21">21</a></th>
<td></td>
</tr><tr><th id="L22"><a href="#L22">22</a></th>
<td><B><span class="code-lang">sub</span></b>&nbsp;CreateXmlFooter</td>
</tr><tr><th id="L23"><a href="#L23">23</a></th>
<td>{</td>
</tr><tr><th id="L24"><a href="#L24">24</a></th>
<td>&nbsp; &nbsp; &nbsp; &nbsp; <B><span class="code-lang">print</span></b> <B><span class="code-string">'&lt;/Connector&gt;'</span></b>;</td>
</tr><tr><th id="L25"><a href="#L25">25</a></th>
<td>}</td>
</tr><tr><th id="L26"><a href="#L26">26</a></th>
<td></td>
</tr><tr><th id="L27"><a href="#L27">27</a></th>
<td><B><span class="code-lang">sub</span></b>&nbsp;SendError</td>
</tr><tr><th id="L28"><a href="#L28">28</a></th>
<td>{</td>
</tr><tr><th id="L29"><a href="#L29">29</a></th>
<td>&nbsp; &nbsp; &nbsp; &nbsp; <B><span class="code-lang">local</span></b>( $number, $text ) = @_;</td>
</tr><tr><th id="L30"><a href="#L30">30</a></th>
<td></td>
</tr><tr><th id="L31"><a href="#L31">31</a></th>
<td>&nbsp; &nbsp; &nbsp; &nbsp; <B><span class="code-lang">print</span></b> &lt;&lt; <B><span class="code-string">&quot;_HTML_HEAD_&quot;</span></b>;</td>
</tr><tr><th id="L32"><a href="#L32">32</a></th>
<td>Content-Type:text/xml; charset=utf-8</td>
</tr><tr><th id="L33"><a href="#L33">33</a></th>
<td>Pragma: <B><span class="code-lang">no</span></b>-cache</td>
</tr><tr><th id="L34"><a href="#L34">34</a></th>
<td>Cache-Control: <B><span class="code-lang">no</span></b>-cache</td>
...
<td>&nbsp; &nbsp; &nbsp; &nbsp; <B><span class="code-lang">print</span></b> <B><span class="code-string">'&lt;Connector&gt;&lt;Error number=&quot;'</span></b> . $number . <B><span class="code-string">'&quot; text=&quot;'</span></b> . &amp;specialchar_cnv( $text ) . <B><span class="code-string">'&quot; /&gt;&lt;/Connector&gt;'</span></b> ;</td>
 ...
 <div id="help">
  ...
  <div id="anydiff">
   <form action="/anydiff" method="get">
    <div class="buttons">
     <input type="hidden" name="new_path" value="/FCKeditor/trunk/editor/filemanager/browser/default/connectors/perl/basexml.pl" />
     <input type="hidden" name="old_path" value="/FCKeditor/trunk/editor/filemanager/browser/default/connectors/perl/basexml.pl" />
...
<div id="altlinks"><h3>Download in other formats:</h3><ul><li class="first"><a href="/browser/FCKeditor/trunk/editor/filemanager/browser/default/connectors/perl/basexml.pl?rev=8&amp;format=txt">Plain Text</a></li><li class="last"><a href="/browser/FCKeditor/trunk/editor/filemanager/browser/default/connectors/perl/basexml.pl?rev=8&amp;format=raw">Original Format</a></li></ul></div>
