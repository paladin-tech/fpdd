...
<div id="ctxtnav" class="nav">
 <ul>
  <li class="first"><a href="/changeset/3/FCKeditor/trunk/editor/filemanager/browser/default/connectors/perl/commands.pl">
   Last Change</a></li>
  <li class="last"><a href="/log/FCKeditor/trunk/editor/filemanager/browser/default/connectors/perl/commands.pl?rev=8">
   Revision Log</a></li>
 </ul>
</div>
...
<div id="content" class="browser">
 ...
 <div id="jumprev">
  ...
  <table id="info" summary="Revision info"><tr>
    <th scope="col">
     Revision <a href="/changeset/3">3</a>, 3.9 kB
...
<td><B><span class="code-lang">sub</span></b>&nbsp;GetFolders</td>
</tr><tr><th id="L9"><a href="#L9">9</a></th>
<td>{</td>
</tr><tr><th id="L10"><a href="#L10">10</a></th>
<td></td>
</tr><tr><th id="L11"><a href="#L11">11</a></th>
<td>&nbsp; &nbsp; &nbsp; &nbsp; <B><span class="code-lang">local</span></b>($resourceType, $currentFolder) = @_;</td>
</tr><tr><th id="L12"><a href="#L12">12</a></th>
<td></td>
</tr><tr><th id="L13"><a href="#L13">13</a></th>
<td>&nbsp; &nbsp; &nbsp; &nbsp; <I><span class="code-comment"># Map the virtual path to the local server path.</span></i></td>
</tr><tr><th id="L14"><a href="#L14">14</a></th>
<td><I><span class="code-comment"></span></i>&nbsp;&nbsp; &nbsp; &nbsp; &nbsp;$sServerDir = &amp;ServerMapFolder($resourceType, $currentFolder);</td>
</tr><tr><th id="L15"><a href="#L15">15</a></th>
<td>&nbsp; &nbsp; &nbsp; &nbsp; <B><span class="code-lang">print</span></b> <B><span class="code-string">&quot;&lt;Folders&gt;&quot;</span></b>;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <I><span class="code-comment"># Open the &quot;Folders&quot; node.</i></span></td>
</tr><tr><th id="L16"><a href="#L16">16</a></th>
<td><span class="code-lang"><I></span></i></td>
</tr><tr><th id="L17"><a href="#L17">17</a></th>
<td>&nbsp; &nbsp; &nbsp; &nbsp; <B><span class="code-lang">opendir</span></b>(DIR,<B><span class="code-string">&quot;$sServerDir&quot;</span></b>);</td>
</tr><tr><th id="L18"><a href="#L18">18</a></th>
<td>&nbsp; &nbsp; &nbsp; &nbsp; @files = <B><span class="code-lang">grep</span></b>(!/^\.\.?$/,<B><span class="code-lang">readdir</span></b>(DIR));</td>
</tr><tr><th id="L19"><a href="#L19">19</a></th>
<td>&nbsp; &nbsp; &nbsp; &nbsp; <B><span class="code-lang">closedir</span></b>(DIR);</td>
</tr><tr><th id="L20"><a href="#L20">20</a></th>
<td></td>
</tr><tr><th id="L21"><a href="#L21">21</a></th>
<td>&nbsp; &nbsp; &nbsp; &nbsp; <B><span class="code-lang">foreach</span></b> $sFile (@files) {</td>
</tr><tr><th id="L22"><a href="#L22">22</a></th>
<td>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <B><span class="code-lang">if</span></b>($sFile != <B><span class="code-string">'.'</span></b> &amp;&amp; $sFile != <B><span class="code-string">'..'</span></b> &amp;&amp; (-d <B><span class="code-string">&quot;$sServerDir$sFile&quot;</span></b>)) {</td>
</tr><tr><th id="L23"><a href="#L23">23</a></th>
<td>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; $cnv_filename = &amp;ConvertToXmlAttribute($sFile);</td>
</tr><tr><th id="L24"><a href="#L24">24</a></th>
<td>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <B><span class="code-lang">print</span></b> <B><span class="code-string">'&lt;Folder name=&quot;'</span></b> . $cnv_filename . <B><span class="code-string">'&quot; /&gt;'</span></b>;</td>
</tr><tr><th id="L25"><a href="#L25">25</a></th>
<td>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; }</td>
</tr><tr><th id="L26"><a href="#L26">26</a></th>
<td>&nbsp; &nbsp; &nbsp; &nbsp; }</td>
</tr><tr><th id="L27"><a href="#L27">27</a></th>
<td>&nbsp; &nbsp; &nbsp; &nbsp; <B><span class="code-lang">print</span></b> <B><span class="code-string">&quot;&lt;/Folders&gt;&quot;</span></b>;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<I><span class="code-comment"># Close the &quot;Folders&quot; node.</i></span></td>
</tr><tr><th id="L28"><a href="#L28">28</a></th>
<td><span class="code-lang"><I></span></i>}</td>
</tr><tr><th id="L29"><a href="#L29">29</a></th>
<td></td>
</tr><tr><th id="L30"><a href="#L30">30</a></th>
<td><B><span class="code-lang">sub</span></b>&nbsp;GetFoldersAndFiles</td>
...
<td>&nbsp; &nbsp; &nbsp; &nbsp; <I><span class="code-comment"># Initialize the output buffers for &quot;Folders&quot; and &quot;Files&quot;.</span></i></td>
</tr><tr><th id="L38"><a href="#L38">38</a></th>
<td><I><span class="code-comment"></span></i>&nbsp;&nbsp; &nbsp; &nbsp; &nbsp;$sFolders&nbsp; &nbsp; &nbsp; &nbsp;= <B><span class="code-string">'&lt;Folders&gt;'</span></b>;</td>
</tr><tr><th id="L39"><a href="#L39">39</a></th>
<td>&nbsp; &nbsp; &nbsp; &nbsp; $sFiles&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;= <B><span class="code-string">'&lt;Files&gt;'</span></b>;</td>
...
<td>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <B><span class="code-lang">if</span></b>($sFile <B><span class="code-lang">ne</span></b> <B><span class="code-string">'.'</span></b> &amp;&amp; $sFile <B><span class="code-lang">ne</span></b> <B><span class="code-string">'..'</span></b>) {</td>
</tr><tr><th id="L47"><a href="#L47">47</a></th>
<td>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <B><span class="code-lang">if</span></b>(-d <B><span class="code-string">&quot;$sServerDir$sFile&quot;</span></b>) {</td>
</tr><tr><th id="L48"><a href="#L48">48</a></th>
<td>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; $cnv_filename = &amp;ConvertToXmlAttribute($sFile);</td>
</tr><tr><th id="L49"><a href="#L49">49</a></th>
<td>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; $sFolders .= <B><span class="code-string">'&lt;Folder name=&quot;'</span></b> . $cnv_filename . <B><span class="code-string">'&quot; /&gt;'</span></b> ;</td>
</tr><tr><th id="L50"><a href="#L50">50</a></th>
<td>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; } <B><span class="code-lang">else</span></b> {</td>
</tr><tr><th id="L51"><a href="#L51">51</a></th>
<td>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; ($iFileSize,$refdate,$filedate,$fileperm) = (<B><span class="code-lang">stat</span></b>(<B><span class="code-string">&quot;$sServerDir$sFile&quot;</span></b>))[7,8,9,2];</td>
</tr><tr><th id="L52"><a href="#L52">52</a></th>
<td>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <B><span class="code-lang">if</span></b>($iFileSize &gt; 0) {</td>
</tr><tr><th id="L53"><a href="#L53">53</a></th>
<td>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; $iFileSize = <B><span class="code-lang">int</span></b>($iFileSize / 1024);</td>
</tr><tr><th id="L54"><a href="#L54">54</a></th>
<td>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <B><span class="code-lang">if</span></b>($iFileSize &lt; 1) {</td>
...
<td>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; $sFiles .= <B><span class="code-string">'&lt;File name=&quot;'</span></b> . $cnv_filename . <B><span class="code-string">'&quot; size=&quot;'</span></b> . $iFileSize . <B><span class="code-string">'&quot; /&gt;'</span></b> ;</td>
...
<td>&nbsp; &nbsp; &nbsp; &nbsp; <B><span class="code-lang">print</span></b> $sFolders ;</td>
</tr><tr><th id="L64"><a href="#L64">64</a></th>
<td>&nbsp; &nbsp; &nbsp; &nbsp; <B><span class="code-lang">print</span></b> <B><span class="code-string">'&lt;/Folders&gt;'</span></b>;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<I><span class="code-comment"># Close the &quot;Folders&quot; node.</i></span></td>
</tr><tr><th id="L65"><a href="#L65">65</a></th>
<td><span class="code-lang"><I></span></i>&nbsp;&nbsp; &nbsp; &nbsp; &nbsp;<B><span class="code-lang">print</span></b> $sFiles ;</td>
</tr><tr><th id="L66"><a href="#L66">66</a></th>
<td>&nbsp; &nbsp; &nbsp; &nbsp; <B><span class="code-lang">print</span></b> <B><span class="code-string">'&lt;/Files&gt;'</span></b>;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<I><span class="code-comment"># Close the &quot;Files&quot; node.</i></span></td>
</tr><tr><th id="L67"><a href="#L67">67</a></th>
<td><span class="code-lang"><I></span></i>}</td>
</tr><tr><th id="L68"><a href="#L68">68</a></th>
<td></td>
</tr><tr><th id="L69"><a href="#L69">69</a></th>
<td><B><span class="code-lang">sub</span></b>&nbsp;CreateFolder</td>
...
<td>&nbsp; &nbsp; &nbsp; &nbsp; $sErrorNumber&nbsp; &nbsp;= <B><span class="code-string">'0'</span></b> ;</td>
</tr><tr><th id="L74"><a href="#L74">74</a></th>
<td>&nbsp; &nbsp; &nbsp; &nbsp; $sErrorMsg&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; = <B><span class="code-string">''</span></b> ;</td>
</tr><tr><th id="L75"><a href="#L75">75</a></th>
<td></td>
</tr><tr><th id="L76"><a href="#L76">76</a></th>
<td>&nbsp; &nbsp; &nbsp; &nbsp; <B><span class="code-lang">if</span></b>($FORM{<B><span class="code-string">'NewFolderName'</span></b>} <B><span class="code-lang">ne</span></b> <B><span class="code-string">&quot;&quot;</span></b>) {</td>
</tr><tr><th id="L77"><a href="#L77">77</a></th>
<td>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; $sNewFolderName = $FORM{<B><span class="code-string">'NewFolderName'</span></b>};</td>
</tr><tr><th id="L78"><a href="#L78">78</a></th>
<td>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <I><span class="code-comment"># Map the virtual path to the local server path of the current folder.</span></i></td>
</tr><tr><th id="L79"><a href="#L79">79</a></th>
<td><I><span class="code-comment"></span></i>&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;$sServerDir = &amp;ServerMapFolder($resourceType, $currentFolder);</td>
</tr><tr><th id="L80"><a href="#L80">80</a></th>
<td>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <B><span class="code-lang">if</span></b>(-w $sServerDir) {</td>
</tr><tr><th id="L81"><a href="#L81">81</a></th>
<td>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; $sServerDir .= $sNewFolderName;</td>
</tr><tr><th id="L82"><a href="#L82">82</a></th>
<td>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; $sErrorMsg = &amp;CreateServerFolder($sServerDir);</td>
</tr><tr><th id="L83"><a href="#L83">83</a></th>
<td>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <B><span class="code-lang">if</span></b>($sErrorMsg == 0) {</td>
</tr><tr><th id="L84"><a href="#L84">84</a></th>
<td>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; $sErrorNumber = <B><span class="code-string">'0'</span></b>;</td>
</tr><tr><th id="L85"><a href="#L85">85</a></th>
<td>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; } <B><span class="code-lang">elsif</span></b>($sErrorMsg <B><span class="code-lang">eq</span></b> <B><span class="code-string">'Invalid argument'</span></b> || $sErrorMsg <B><span class="code-lang">eq</span></b> <B><span class="code-string">'No such file or directory'</span></b>) {</td>
</tr><tr><th id="L86"><a href="#L86">86</a></th>
<td>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; $sErrorNumber = <B><span class="code-string">'102'</span></b>;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <I><span class="code-comment">#// Path too long.</i></span></td>
...
<td>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; $sErrorNumber = <B><span class="code-string">'110'</span></b>;</td>
</tr><tr><th id="L89"><a href="#L89">89</a></th>
<td>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; }</td>
</tr><tr><th id="L90"><a href="#L90">90</a></th>
<td>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; } <B><span class="code-lang">else</span></b> {</td>
</tr><tr><th id="L91"><a href="#L91">91</a></th>
<td>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; $sErrorNumber = <B><span class="code-string">'103'</span></b>;</td>
</tr><tr><th id="L92"><a href="#L92">92</a></th>
<td>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; }</td>
</tr><tr><th id="L93"><a href="#L93">93</a></th>
<td>&nbsp; &nbsp; &nbsp; &nbsp; } <B><span class="code-lang">else</span></b> {</td>
</tr><tr><th id="L94"><a href="#L94">94</a></th>
<td>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; $sErrorNumber = <B><span class="code-string">'102'</span></b> ;</td>
</tr><tr><th id="L95"><a href="#L95">95</a></th>
<td>&nbsp; &nbsp; &nbsp; &nbsp; }</td>
</tr><tr><th id="L96"><a href="#L96">96</a></th>
<td>&nbsp; &nbsp; &nbsp; &nbsp; <I><span class="code-comment"># Create the &quot;Error&quot; node.</span></i></td>
</tr><tr><th id="L97"><a href="#L97">97</a></th>
<td><I><span class="code-comment"></span></i>&nbsp;&nbsp; &nbsp; &nbsp; &nbsp;$cnv_errmsg = &amp;ConvertToXmlAttribute($sErrorMsg);</td>
</tr><tr><th id="L98"><a href="#L98">98</a></th>
<td>&nbsp; &nbsp; &nbsp; &nbsp; <B><span class="code-lang">print</span></b> <B><span class="code-string">'&lt;Error number=&quot;'</span></b> . $sErrorNumber . <B><span class="code-string">'&quot; originalDescription=&quot;'</span></b> . $cnv_errmsg . <B><span class="code-string">'&quot; /&gt;'</span></b>;</td>
</tr><tr><th id="L99"><a href="#L99">99</a></th>
<td>}</td>
</tr><tr><th id="L100"><a href="#L100">100</a></th>
<td></td>
</tr><tr><th id="L101"><a href="#L101">101</a></th>
<td><B><span class="code-lang">sub</span></b>&nbsp;FileUpload</td>
...
<td>&nbsp; &nbsp; &nbsp; &nbsp; $sFileName = <B><span class="code-string">''</span></b> ;</td>
</tr><tr><th id="L109"><a href="#L109">109</a></th>
<td>&nbsp; &nbsp; &nbsp; &nbsp; <B><span class="code-lang">if</span></b>($new_fname) {</td>
...
<td>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <I><span class="code-comment"># Get the uploaded file name.</span></i></td>
</tr><tr><th id="L114"><a href="#L114">114</a></th>
<td><I><span class="code-comment"></span></i>&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;$sFileName = $new_fname;</td>
...
<td>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <B><span class="code-lang">if</span></b>(-e $sFilePath) {</td>
</tr><tr><th id="L121"><a href="#L121">121</a></th>
<td>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; $iCounter++ ;</td>
</tr><tr><th id="L122"><a href="#L122">122</a></th>
<td>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; ($path,$BaseName,$ext) = &amp;RemoveExtension($sOriginalFileName);</td>
</tr><tr><th id="L123"><a href="#L123">123</a></th>
<td>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; $sFileName = $BaseName . <B><span class="code-string">'('</span></b> . $iCounter . <B><span class="code-string">').'</span></b> . $ext;</td>
</tr><tr><th id="L124"><a href="#L124">124</a></th>
<td>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; $sErrorNumber = <B><span class="code-string">'201'</span></b>;</td>
</tr><tr><th id="L125"><a href="#L125">125</a></th>
<td>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; } <B><span class="code-lang">else</span></b> {</td>
</tr><tr><th id="L126"><a href="#L126">126</a></th>
<td>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; copy(<B><span class="code-string">&quot;$img_dir/$new_fname&quot;</span></b>,<B><span class="code-string">&quot;$sFilePath&quot;</span></b>);</td>
</tr><tr><th id="L127"><a href="#L127">127</a></th>
<td>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <B><span class="code-lang">chmod</span></b>(0777,$sFilePath);</td>
</tr><tr><th id="L128"><a href="#L128">128</a></th>
<td>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <B><span class="code-lang">unlink</span></b>(<B><span class="code-string">&quot;$img_dir/$new_fname&quot;</span></b>);</td>
...
<td>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; $sErrorNumber = <B><span class="code-string">'202'</span></b> ;</td>
</tr><tr><th id="L134"><a href="#L134">134</a></th>
<td>&nbsp; &nbsp; &nbsp; &nbsp; }</td>
</tr><tr><th id="L135"><a href="#L135">135</a></th>
<td>&nbsp; &nbsp; &nbsp; &nbsp; $sFileName&nbsp; &nbsp; &nbsp; =~ <B><span class="code-lang">s</span></b>/<B><span class="code-string">&quot;/\\&quot;</span></b>/g;</td>
...
<td>&nbsp; &nbsp; &nbsp; &nbsp; <B><span class="code-lang">print</span></b> <B><span class="code-string">'&lt;script type=&quot;text/javascript&quot;&gt;'</span></b>;</td>
</tr><tr><th id="L138"><a href="#L138">138</a></th>
<td>&nbsp; &nbsp; &nbsp; &nbsp; <B><span class="code-lang">print</span></b> <B><span class="code-string">'window.parent.frames[&quot;frmUpload&quot;].OnUploadCompleted('</span></b> . $sErrorNumber . <B><span class="code-string">',&quot;'</span></b> . $sFileName . <B><span class="code-string">'&quot;) ;'</span></b>;</td>
</tr><tr><th id="L139"><a href="#L139">139</a></th>
<td>&nbsp; &nbsp; &nbsp; &nbsp; <B><span class="code-lang">print</span></b> <B><span class="code-string">'&lt;/script&gt;'</span></b>;</td>
 ...
 <div id="help">
  ...
  <div id="anydiff">
   <form action="/anydiff" method="get">
    <div class="buttons">
     <input type="hidden" name="new_path" value="/FCKeditor/trunk/editor/filemanager/browser/default/connectors/perl/commands.pl" />
     <input type="hidden" name="old_path" value="/FCKeditor/trunk/editor/filemanager/browser/default/connectors/perl/commands.pl" />
...
<div id="altlinks"><h3>Download in other formats:</h3><ul><li class="first"><a href="/browser/FCKeditor/trunk/editor/filemanager/browser/default/connectors/perl/commands.pl?rev=8&amp;format=txt">Plain Text</a></li><li class="last"><a href="/browser/FCKeditor/trunk/editor/filemanager/browser/default/connectors/perl/commands.pl?rev=8&amp;format=raw">Original Format</a></li></ul></div>
