...
<head>
 <title>/FCKeditor/trunk/editor/filemanager/upload/lasso/config.lasso - FCKeditor - Trac</title><link rel="start" href="/wiki" /><link rel="search" href="/search" /><link rel="help" href="/wiki/TracGuide" /><link rel="stylesheet" href="/chrome/common/css/trac.css" type="text/css" /><link rel="stylesheet" href="/chrome/common/css/code.css" type="text/css" /><link rel="stylesheet" href="/chrome/common/css/browser.css" type="text/css" /><link rel="icon" href="http://www.fckeditor.net/favicon.ico" type="image/x-icon" /><link rel="shortcut icon" href="http://www.fckeditor.net/favicon.ico" type="image/x-icon" /><link rel="up" href="/browser/FCKeditor/trunk/editor/filemanager/upload/lasso?rev=8" title="Parent directory" /><link rel="alternate" href="/browser/FCKeditor/trunk/editor/filemanager/upload/lasso/config.lasso?rev=8&amp;format=raw" title="Original Format" type="text/plain" /><style type="text/css">
</style>
...
<div id="ctxtnav" class="nav">
 <ul>
  <li class="first"><a href="/changeset/3/FCKeditor/trunk/editor/filemanager/upload/lasso/config.lasso">
   Last Change</a></li>
  <li class="last"><a href="/log/FCKeditor/trunk/editor/filemanager/upload/lasso/config.lasso?rev=8">
   Revision Log</a></li>
 </ul>
</div>
...
<div id="content" class="browser">
 <h1><a class="first" title="Go to root directory" href="/browser?rev=8">root</a><span class="sep">/</span><a title="View FCKeditor" href="/browser/FCKeditor?rev=8">FCKeditor</a><span class="sep">/</span><a title="View trunk" href="/browser/FCKeditor/trunk?rev=8">trunk</a><span class="sep">/</span><a title="View editor" href="/browser/FCKeditor/trunk/editor?rev=8">editor</a><span class="sep">/</span><a title="View filemanager" href="/browser/FCKeditor/trunk/editor/filemanager?rev=8">filemanager</a><span class="sep">/</span><a title="View upload" href="/browser/FCKeditor/trunk/editor/filemanager/upload?rev=8">upload</a><span class="sep">/</span><a title="View lasso" href="/browser/FCKeditor/trunk/editor/filemanager/upload/lasso?rev=8">lasso</a><span class="sep">/</span><a title="View config.lasso" href="/browser/FCKeditor/trunk/editor/filemanager/upload/lasso/config.lasso?rev=8">config.lasso</a></h1>
...
<td>&nbsp;* File Name: config.php</td>
</tr><tr><th id="L13"><a href="#L13">13</a></th>
<td>&nbsp;*&nbsp; &nbsp; &nbsp; Configuration file for the Lasso File Uploader.</td>
...
<td>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 'File' = array('php','php2','php3','php4','php5','phtml','pwml','inc','asp','aspx','ascx','jsp','cfm','cfc','pl','bat','exe','com','dll','vbs','js','reg','cgi','lasso','lassoapp'),</td>
 ...
 <div id="help">
  ...
  <div id="anydiff">
   <form action="/anydiff" method="get">
    <div class="buttons">
     <input type="hidden" name="new_path" value="/FCKeditor/trunk/editor/filemanager/upload/lasso/config.lasso" />
     <input type="hidden" name="old_path" value="/FCKeditor/trunk/editor/filemanager/upload/lasso/config.lasso" />
...
<div id="altlinks"><h3>Download in other formats:</h3><ul><li class="first last"><a href="/browser/FCKeditor/trunk/editor/filemanager/upload/lasso/config.lasso?rev=8&amp;format=raw">Original Format</a></li></ul></div>
