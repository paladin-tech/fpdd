...
<head>
 <title>/FCKeditor/trunk/editor/filemanager/upload/asp/upload.asp - FCKeditor - Trac</title><link rel="start" href="/wiki" /><link rel="search" href="/search" /><link rel="help" href="/wiki/TracGuide" /><link rel="stylesheet" href="/chrome/common/css/trac.css" type="text/css" /><link rel="stylesheet" href="/chrome/common/css/code.css" type="text/css" /><link rel="stylesheet" href="/chrome/common/css/browser.css" type="text/css" /><link rel="icon" href="http://www.fckeditor.net/favicon.ico" type="image/x-icon" /><link rel="shortcut icon" href="http://www.fckeditor.net/favicon.ico" type="image/x-icon" /><link rel="up" href="/browser/FCKeditor/trunk/editor/filemanager/upload/asp?rev=8" title="Parent directory" /><link rel="alternate" href="/browser/FCKeditor/trunk/editor/filemanager/upload/asp/upload.asp?rev=8&amp;format=txt" title="Plain Text" type="text/plain" /><link rel="alternate" href="/browser/FCKeditor/trunk/editor/filemanager/upload/asp/upload.asp?rev=8&amp;format=raw" title="Original Format" type="text/x-asp; charset=utf-8" /><style type="text/css">
</style>
...
<div id="ctxtnav" class="nav">
 <ul>
  <li class="first"><a href="/changeset/3/FCKeditor/trunk/editor/filemanager/upload/asp/upload.asp">
   Last Change</a></li>
  <li class="last"><a href="/log/FCKeditor/trunk/editor/filemanager/upload/asp/upload.asp?rev=8">
   Revision Log</a></li>
 </ul>
</div>
...
<div id="content" class="browser">
 <h1><a class="first" title="Go to root directory" href="/browser?rev=8">root</a><span class="sep">/</span><a title="View FCKeditor" href="/browser/FCKeditor?rev=8">FCKeditor</a><span class="sep">/</span><a title="View trunk" href="/browser/FCKeditor/trunk?rev=8">trunk</a><span class="sep">/</span><a title="View editor" href="/browser/FCKeditor/trunk/editor?rev=8">editor</a><span class="sep">/</span><a title="View filemanager" href="/browser/FCKeditor/trunk/editor/filemanager?rev=8">filemanager</a><span class="sep">/</span><a title="View upload" href="/browser/FCKeditor/trunk/editor/filemanager/upload?rev=8">upload</a><span class="sep">/</span><a title="View asp" href="/browser/FCKeditor/trunk/editor/filemanager/upload/asp?rev=8">asp</a><span class="sep">/</span><a title="View upload.asp" href="/browser/FCKeditor/trunk/editor/filemanager/upload/asp/upload.asp?rev=8">upload.asp</a></h1>
...
<td>&lt;%@ CodePage=65001 Language=&#34;VBScript&#34;%&gt;</td>
</tr><tr><th id="L2"><a href="#L2">2</a></th>
<td>&lt;%</td>
</tr><tr><th id="L3"><a href="#L3">3</a></th>
<td>Option Explicit</td>
</tr><tr><th id="L4"><a href="#L4">4</a></th>
<td>Response.Buffer = True</td>
...
<td>&nbsp; &nbsp; &nbsp; &nbsp; This is the &#34;File Uploader&#34; for ASP.</td>
...
<td>&lt;!--#include file=&#34;config.asp&#34;--&gt;</td>
</tr><tr><th id="L13"><a href="#L13">13</a></th>
<td>&lt;!--#include file=&#34;io.asp&#34;--&gt;</td>
</tr><tr><th id="L14"><a href="#L14">14</a></th>
<td>&lt;!--#include file=&#34;class_upload.asp&#34;--&gt;</td>
</tr><tr><th id="L15"><a href="#L15">15</a></th>
<td>&lt;%</td>
</tr><tr><th id="L16"><a href="#L16">16</a></th>
<td></td>
</tr><tr><th id="L17"><a href="#L17">17</a></th>
<td>' This is the function that sends the results of the uploading process.</td>
</tr><tr><th id="L18"><a href="#L18">18</a></th>
<td>Function SendResults( errorNumber, fileUrl, fileName, customMsg )</td>
</tr><tr><th id="L19"><a href="#L19">19</a></th>
<td>&nbsp; &nbsp; &nbsp; &nbsp; Response.Write &#34;&lt;script type=&#34;&#34;text/javascript&#34;&#34;&gt;&#34;</td>
</tr><tr><th id="L20"><a href="#L20">20</a></th>
<td>&nbsp; &nbsp; &nbsp; &nbsp; Response.Write &#34;window.parent.OnUploadCompleted(&#34; &amp; errorNumber &amp; &#34;,&#34;&#34;&#34; &amp; Replace( fileUrl, &#34;&#34;&#34;&#34;, &#34;\&#34;&#34;&#34; ) &amp; &#34;&#34;&#34;,&#34;&#34;&#34; &amp; Replace( fileName, &#34;&#34;&#34;&#34;, &#34;\&#34;&#34;&#34; ) &amp; &#34;&#34;&#34;,&#34;&#34;&#34; &amp; Replace( customMsg , &#34;&#34;&#34;&#34;, &#34;\&#34;&#34;&#34; ) &amp; &#34;&#34;&#34;) ;&#34;</td>
...
<td>' Check if this uploader has been enabled.</td>
</tr><tr><th id="L29"><a href="#L29">29</a></th>
<td>If ( ConfigIsEnabled = False ) Then</td>
</tr><tr><th id="L30"><a href="#L30">30</a></th>
<td>&nbsp; &nbsp; &nbsp; &nbsp; SendResults &#34;1&#34;, &#34;&#34;, &#34;&#34;, &#34;This file uploader is disabled. Please check the &#34;&#34;editor/filemanager/upload/asp/config.asp&#34;&#34; file&#34;</td>
</tr><tr><th id="L31"><a href="#L31">31</a></th>
<td>End If</td>
</tr><tr><th id="L32"><a href="#L32">32</a></th>
<td></td>
</tr><tr><th id="L33"><a href="#L33">33</a></th>
<td>' The the file type (from the QueryString, by default 'File').</td>
</tr><tr><th id="L34"><a href="#L34">34</a></th>
<td>Dim resourceType</td>
</tr><tr><th id="L35"><a href="#L35">35</a></th>
<td>If ( Request.QueryString(&#34;Type&#34;) &lt;&gt; &#34;&#34; ) Then</td>
</tr><tr><th id="L36"><a href="#L36">36</a></th>
<td>&nbsp; &nbsp; &nbsp; &nbsp; resourceType = Request.QueryString(&#34;Type&#34;)</td>
</tr><tr><th id="L37"><a href="#L37">37</a></th>
<td>Else</td>
</tr><tr><th id="L38"><a href="#L38">38</a></th>
<td>&nbsp; &nbsp; &nbsp; &nbsp; resourceType = &#34;File&#34;</td>
</tr><tr><th id="L39"><a href="#L39">39</a></th>
<td>End If</td>
</tr><tr><th id="L40"><a href="#L40">40</a></th>
<td></td>
</tr><tr><th id="L41"><a href="#L41">41</a></th>
<td>' Create the Uploader object.</td>
...
<td>&nbsp; &nbsp; &nbsp; &nbsp; SendResults &#34;202&#34;, &#34;&#34;, &#34;&#34;, &#34;&#34;</td>
</tr><tr><th id="L51"><a href="#L51">51</a></th>
<td>Else</td>
</tr><tr><th id="L52"><a href="#L52">52</a></th>
<td>&nbsp; &nbsp; &nbsp; &nbsp; Dim sFileName, sFileUrl, sErrorNumber, sOriginalFileName, sExtension</td>
...
<td>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; If oUploader.ErrNum &gt; 0 Then SendResults &#34;202&#34;, &#34;&#34;, &#34;&#34;, &#34;&#34;</td>
 ...
 <div id="help">
  ...
  <div id="anydiff">
   <form action="/anydiff" method="get">
    <div class="buttons">
     <input type="hidden" name="new_path" value="/FCKeditor/trunk/editor/filemanager/upload/asp/upload.asp" />
     <input type="hidden" name="old_path" value="/FCKeditor/trunk/editor/filemanager/upload/asp/upload.asp" />
...
<div id="altlinks"><h3>Download in other formats:</h3><ul><li class="first"><a href="/browser/FCKeditor/trunk/editor/filemanager/upload/asp/upload.asp?rev=8&amp;format=txt">Plain Text</a></li><li class="last"><a href="/browser/FCKeditor/trunk/editor/filemanager/upload/asp/upload.asp?rev=8&amp;format=raw">Original Format</a></li></ul></div>
