...
<head>
 <title>/FCKeditor/trunk/editor/filemanager/upload/php/config.php - FCKeditor - Trac</title><link rel="start" href="/wiki" /><link rel="search" href="/search" /><link rel="help" href="/wiki/TracGuide" /><link rel="stylesheet" href="/chrome/common/css/trac.css" type="text/css" /><link rel="stylesheet" href="/chrome/common/css/code.css" type="text/css" /><link rel="stylesheet" href="/chrome/common/css/browser.css" type="text/css" /><link rel="icon" href="http://www.fckeditor.net/favicon.ico" type="image/x-icon" /><link rel="shortcut icon" href="http://www.fckeditor.net/favicon.ico" type="image/x-icon" /><link rel="up" href="/browser/FCKeditor/trunk/editor/filemanager/upload/php?rev=8" title="Parent directory" /><link rel="alternate" href="/browser/FCKeditor/trunk/editor/filemanager/upload/php/config.php?rev=8&amp;format=txt" title="Plain Text" type="text/plain" /><link rel="alternate" href="/browser/FCKeditor/trunk/editor/filemanager/upload/php/config.php?rev=8&amp;format=raw" title="Original Format" type="text/x-php; charset=utf-8" /><style type="text/css">
</style>
...
<div id="ctxtnav" class="nav">
 <ul>
  <li class="first"><a href="/changeset/3/FCKeditor/trunk/editor/filemanager/upload/php/config.php">
   Last Change</a></li>
  <li class="last"><a href="/log/FCKeditor/trunk/editor/filemanager/upload/php/config.php?rev=8">
   Revision Log</a></li>
 </ul>
</div>
...
<div id="content" class="browser">
 <h1><a class="first" title="Go to root directory" href="/browser?rev=8">root</a><span class="sep">/</span><a title="View FCKeditor" href="/browser/FCKeditor?rev=8">FCKeditor</a><span class="sep">/</span><a title="View trunk" href="/browser/FCKeditor/trunk?rev=8">trunk</a><span class="sep">/</span><a title="View editor" href="/browser/FCKeditor/trunk/editor?rev=8">editor</a><span class="sep">/</span><a title="View filemanager" href="/browser/FCKeditor/trunk/editor/filemanager?rev=8">filemanager</a><span class="sep">/</span><a title="View upload" href="/browser/FCKeditor/trunk/editor/filemanager/upload?rev=8">upload</a><span class="sep">/</span><a title="View php" href="/browser/FCKeditor/trunk/editor/filemanager/upload/php?rev=8">php</a><span class="sep">/</span><a title="View config.php" href="/browser/FCKeditor/trunk/editor/filemanager/upload/php/config.php?rev=8">config.php</a></h1>
...
<td><span class="code-lang">&nbsp;&nbsp; &nbsp;Configuration file for the PHP File Uploader.</span></td>
...
<td><span class="code-comment">// SECURITY: You must explicitelly enable this "uploader". </span></td>
...
<td><span class="code-lang">// Set if the file type must be considere in the target path. </span></td>
</tr><tr><th id="L15"><a href="#L15">15</a></th>
<td><span class="code-lang">// Ex: /UserFiles/Image/ or /UserFiles/File/</span></td>
</tr><tr><th id="L16"><a href="#L16">16</a></th>
<td><span class="code-lang">$Config</span><span class="code-keyword">[</span><span class="code-string">'UseFileType'</span><span class="code-keyword">] = </span><span class="code-lang">false </span><span class="code-keyword">;</span></td>
</tr><tr><th id="L17"><a href="#L17">17</a></th>
<td></td>
</tr><tr><th id="L18"><a href="#L18">18</a></th>
<td><span class="code-comment">// Path to uploaded files relative to the document root.</span></td>
...
<td><span class="code-lang">$Config</span><span class="code-keyword">[</span><span class="code-string">'DeniedExtensions'</span><span class="code-keyword">][</span><span class="code-string">'File'</span><span class="code-keyword">]&nbsp; &nbsp; &nbsp; &nbsp; = array(</span><span class="code-string">'php'</span><span class="code-keyword">,</span><span class="code-string">'php2'</span><span class="code-keyword">,</span><span class="code-string">'php3'</span><span class="code-keyword">,</span><span class="code-string">'php4'</span><span class="code-keyword">,</span><span class="code-string">'php5'</span><span class="code-keyword">,</span><span class="code-string">'phtml'</span><span class="code-keyword">,</span><span class="code-string">'pwml'</span><span class="code-keyword">,</span><span class="code-string">'inc'</span><span class="code-keyword">,</span><span class="code-string">'asp'</span><span class="code-keyword">,</span><span class="code-string">'aspx'</span><span class="code-keyword">,</span><span class="code-string">'ascx'</span><span class="code-keyword">,</span><span class="code-string">'jsp'</span><span class="code-keyword">,</span><span class="code-string">'cfm'</span><span class="code-keyword">,</span><span class="code-string">'cfc'</span><span class="code-keyword">,</span><span class="code-string">'pl'</span><span class="code-keyword">,</span><span class="code-string">'bat'</span><span class="code-keyword">,</span><span class="code-string">'exe'</span><span class="code-keyword">,</span><span class="code-string">'com'</span><span class="code-keyword">,</span><span class="code-string">'dll'</span><span class="code-keyword">,</span><span class="code-string">'vbs'</span><span class="code-keyword">,</span><span class="code-string">'js'</span><span class="code-keyword">,</span><span class="code-string">'reg'</span><span class="code-keyword">,</span><span class="code-string">'cgi'</span><span class="code-keyword">) ;</span></td>
 ...
 <div id="help">
  ...
  <div id="anydiff">
   <form action="/anydiff" method="get">
    <div class="buttons">
     <input type="hidden" name="new_path" value="/FCKeditor/trunk/editor/filemanager/upload/php/config.php" />
     <input type="hidden" name="old_path" value="/FCKeditor/trunk/editor/filemanager/upload/php/config.php" />
...
<div id="altlinks"><h3>Download in other formats:</h3><ul><li class="first"><a href="/browser/FCKeditor/trunk/editor/filemanager/upload/php/config.php?rev=8&amp;format=txt">Plain Text</a></li><li class="last"><a href="/browser/FCKeditor/trunk/editor/filemanager/upload/php/config.php?rev=8&amp;format=raw">Original Format</a></li></ul></div>
