...
<div id="ctxtnav" class="nav">
 <ul>
  <li class="first"><a href="/changeset/3/FCKeditor/trunk/editor/_source/classes/fckstyledef_gecko.js">
   Last Change</a></li>
  <li class="last"><a href="/log/FCKeditor/trunk/editor/_source/classes/fckstyledef_gecko.js?rev=8">
   Revision Log</a></li>
 </ul>
</div>
...
<div id="content" class="browser">
 ...
 <div id="jumprev">
  ...
  <table id="info" summary="Revision info"><tr>
    <th scope="col">
     Revision <a href="/changeset/3">3</a>, 2.4 kB
...
<td><I><span class="code-comment">&nbsp;&nbsp; &nbsp; &nbsp; &nbsp;FCKStyleDef Class: represents a single stylke definition. (Gecko specific)</span></i></td>
...
<td>&nbsp; &nbsp; &nbsp; &nbsp; <B><span class="code-lang">if</span></b> ( FCKSelection.GetType() == <B><span class="code-string">'Text'</span></b> &amp;&amp; !<B><span class="code-lang">this</span></b>.IsObjectElement )</td>
</tr><tr><th id="L11"><a href="#L11">11</a></th>
<td>&nbsp; &nbsp; &nbsp; &nbsp; {</td>
</tr><tr><th id="L12"><a href="#L12">12</a></th>
<td>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <B><span class="code-lang">var</span></b> oSelection = FCK.ToolbarSet.CurrentInstance.EditorWindow.getSelection() ;</td>
</tr><tr><th id="L13"><a href="#L13">13</a></th>
<td>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; </td>
</tr><tr><th id="L14"><a href="#L14">14</a></th>
<td>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <I><span class="code-comment">// Create the main element.</span></i></td>
</tr><tr><th id="L15"><a href="#L15">15</a></th>
<td><I><span class="code-comment"></span></i>&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<B><span class="code-lang">var</span></b> e = FCK.ToolbarSet.CurrentInstance.EditorDocument.createElement( <B><span class="code-lang">this</span></b>.Element ) ;</td>
</tr><tr><th id="L16"><a href="#L16">16</a></th>
<td>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; </td>
</tr><tr><th id="L17"><a href="#L17">17</a></th>
<td>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <B><span class="code-lang">for</span></b> ( <B><span class="code-lang">var</span></b> i = 0 ; i &lt; oSelection.rangeCount ; i++ )</td>
</tr><tr><th id="L18"><a href="#L18">18</a></th>
<td>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; {</td>
</tr><tr><th id="L19"><a href="#L19">19</a></th>
<td>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; e.appendChild( oSelection.getRangeAt(i).extractContents() ) ;</td>
...
<td>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <B><span class="code-lang">var</span></b> oRange = oSelection.getRangeAt(0) ;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</td>
</tr><tr><th id="L29"><a href="#L29">29</a></th>
<td>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; oRange.insertNode( e ) ;</td>
...
<td>&nbsp; &nbsp; &nbsp; &nbsp; <B><span class="code-lang">for</span></b> ( <B><span class="code-lang">var</span></b> i = 0 ; i &lt; parent.childNodes.length ; i++ )</td>
</tr><tr><th id="L57"><a href="#L57">57</a></th>
<td>&nbsp; &nbsp; &nbsp; &nbsp; {</td>
</tr><tr><th id="L58"><a href="#L58">58</a></th>
<td>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <B><span class="code-lang">var</span></b> oChild = parent.childNodes[i] ;</td>
</tr><tr><th id="L59"><a href="#L59">59</a></th>
<td>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; </td>
</tr><tr><th id="L60"><a href="#L60">60</a></th>
<td>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <B><span class="code-lang">if</span></b> ( oChild.nodeType != 1 )</td>
</tr><tr><th id="L61"><a href="#L61">61</a></th>
<td>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <B><span class="code-lang">continue</span></b> ;</td>
...
<td>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <B><span class="code-lang">if</span></b> ( e.getAttribute( a ) != <B><span class="code-lang">this</span></b>.Attributes[a] )</td>
...
<td>&nbsp; &nbsp; &nbsp; &nbsp; <B><span class="code-lang">var</span></b> oParent = elementToCheck.parentNode ;</td>
</tr><tr><th id="L90"><a href="#L90">90</a></th>
<td></td>
</tr><tr><th id="L91"><a href="#L91">91</a></th>
<td>&nbsp; &nbsp; &nbsp; &nbsp; <B><span class="code-lang">if</span></b> ( elementToCheck.nodeType == 1 &amp;&amp; <B><span class="code-lang">this</span></b>.IsEqual( elementToCheck ) )</td>
 ...
 <div id="help">
  ...
  <div id="anydiff">
   <form action="/anydiff" method="get">
    <div class="buttons">
     <input type="hidden" name="new_path" value="/FCKeditor/trunk/editor/_source/classes/fckstyledef_gecko.js" />
     <input type="hidden" name="old_path" value="/FCKeditor/trunk/editor/_source/classes/fckstyledef_gecko.js" />
...
<div id="altlinks"><h3>Download in other formats:</h3><ul><li class="first"><a href="/browser/FCKeditor/trunk/editor/_source/classes/fckstyledef_gecko.js?rev=8&amp;format=txt">Plain Text</a></li><li class="last"><a href="/browser/FCKeditor/trunk/editor/_source/classes/fckstyledef_gecko.js?rev=8&amp;format=raw">Original Format</a></li></ul></div>
